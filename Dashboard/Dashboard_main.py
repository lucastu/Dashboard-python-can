    ...
    try:
        while not stop_reading.is_set():
            ...
            #
                ...
                activeMode = 0
                # print (data)
                if  (data[0] & 0b100000000) == 0b100000000 :
                    activeMode = 1  # .leftRightBalance
                elif (data[1] & 0b100000000) == 0b10000000 :
                    activeMode = 2  # .frontRearBalance
                elif (data[2] & 0b100000000) == 0b10000000 :
                    activeMode = 3  # .bass
                elif (data[4] & 0b100000000) == 0b10000000 :
                    activeMode = 4  # .treble
                elif (data[5] & 0b100000000) == 0b10000000 :
                    activeMode = 5  # .loudness
                elif (data[5] & 0b00010000) == 0b00010000 :
                    activeMode = 6  # .automaticVolume
                elif (data[6] & 0b00100000) == 0b00100000 :
                ...
                elif (data[6] & 0b10111111) == 0x13 :
                    equalizerSetting = 4  # .vocals
                elif (data[6] & 0b10111111) == 0x17 :
